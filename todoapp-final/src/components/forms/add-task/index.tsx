    ...
    return (
        ...
        <Form onSubmit={handleSubmit(onSubmit)}>
            <Form.Group className="mb-3" controlId="formBasicTitle">
                ...
                <Form.Control type="text" placeholder="Ingresar título" { ...register('title') } />
            ...
            <Form.Group className="mb-3" controlId="formBasicDate">
                ...
                <Form.Control type="date" placeholder="Ingresar Fecha" { ...register('date') } />
                <Form.Text className="text-danger">
                    Estan mal los datos
                </Form.Text>
            </Form.Group>
            ...
            <Form.Group className="mb-3" controlId="formBasicDescription">
                ...
                <Form.Select defaultValue={0} aria-label="Default select example" {...register('category')}>
            ...
            <Form.Group className="mb-3" controlId="formBasicDescription">
                ...
                <Form.Control type="text" as="textarea" rows={3} placeholder="Ingresar descripción" { ...register('description') } />
                <Form.Text className="text-danger">
                    Estan mal los datos
                </Form.Text>
            </Form.Group>
            ...
            <Form.Group className="mb-3" controlId="formBasicDescription">
                <Form.Label>Estado</Form.Label>
                <Form.Select defaultValue={0} aria-label="Default select example" {...register('status')}>
                    <option disabled>Seleccionar estado...</option>
